...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    if (response.status === "success") {
      console.log(response.data.data.us);
      const data = {
        id_account: response.data.data.id,
        username: response.data.data.username,
        create_date: response.data.data.create_date,
        role: response.data.data.roles?.map((value) => value.role.role_name),
        gender: response.data.data.infoAccount.gender,
        address: []
      };
      //INFO ACCOUNT
      if (
        response.data.data.infoAccount &&
        response.data.data.infoAccount.fullname
      ) {
      ...
      if (
        response.data.data.infoAccount &&
        response.data.data.infoAccount.image
      ) {
      ...
      if (
        response.data.data.infoAccount &&
        response.data.data.infoAccount.id_card
      ) {
      ...
      if (
        response.data.data.infoAccount &&
        response.data.data.infoAccount.phone
      ) {
      ...
      if (
        response.data.data.infoAccount &&
        response.data.data.infoAccount.email
      ) {
